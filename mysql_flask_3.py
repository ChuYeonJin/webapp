...
# def create():
#     if request.method == 'GET':
#         return (render_template('create_id.html'))
#
#     name = request.form['name']
#     tel = request.form['tel']
#
#     sql = "INSERT INTO `testdb`.`clients` (`cli_name`, `cli_tel`) VALUES ('"+ name +"', '"+ tel +"')"
#
#     result = cud(sql)
#
#     if result == 0:
...
# def update():
#     if request.method == "GET":
#         return (render_template('update_tel.html'))
#
#     name = request.form['name']
#     tel = request.form['tel']
#     sql = "UPDATE clients SET cli_tel='"+ tel +"' where cli_name = '"+ name +"'"
#
#     result = cud(sql)
#
#     if result == 0:
...
#     name = request.form['name']
#     tel = request.form['tel']
#     sql = "DELETE FROM clients WHERE cli_name = '"+ name +"' AND cli_tel = '"+ tel +"'"
#
#     result = cud(sql)
#
#     if result == 0:
